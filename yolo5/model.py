...
def get_yolo5_train_model(model_type, anchors, num_classes, weights_path=None, freeze_level=1, optimizer=Adam(lr=1e-3), label_smoothing=0, elim_grid_sense=True, model_pruning=False, pruning_end_step=10000):
